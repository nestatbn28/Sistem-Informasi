...
<body>
    ...
    <div class="choose-us-area pt-70 pb-20" id="page" >
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class=" text-center">
                        <img src="{{url('/img/fotopakerik1.png')}}" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="single-choose-item">
                        <h6><a href="#"><i class="fas fa-user"></i>Erikson Sianipar</a></h6>
                        <p>Chief Executive Officer of BISUKMA Foundation</p>
                    </div>
                    <div class="single-choose-item">
                        <h6><a href="#"><i class="fas fa-gem"></i> Yayasan dibentuk pada : </a></h6>
                        <p>19 April 2021</p>
                    </div>
                    <div class="single-choose-item">
                        <h6><a href="#"><i class="fas fa-briefcase"></i> Yayasan yang bergerak dibidang : </a></h6>
                        <p> 1. Pendidikan <br> 2. Pertanian <br>3. Pariwisata <br>4. enterpreneurship / UMKM</p>
                    </div>
                </div>
            </div>
        </div>
