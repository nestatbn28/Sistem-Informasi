...
<!-- Favicon -->
<link rel="shortcut icon" type="image/x-icon" href="{{ url('/img/logofull.png') }}">
...
<body>
                    ...
                    <div class="slider-carousel owl-carousel">
                        <div class="single-slider slider-bg-1 text-center">
                            <div class="slider-inner">
                                <h1>SELAMAT DATANG DI BISUKMA</h1>
                                <h5>Berpikir Bisuk, Bekerja Bisuk, Berkomunikasi Bisuk</h5>
                            </div>
                        </div>
                        <div class="single-slider slider-bg-8 text-center">
                            <div class="slider-inner">
                                <h1 style="color: #32A195;">Reminder!</h1>
                                <h5 style="color: #32A195;">Sekarang versi mobile untuk scan barcode telah tersedia</h5>
                            </div>
                        </div>
                        <div class="single-slider slider-bg-1 text-center">
                            <div class="slider-inner">
                                <h1>Pendidikan</h1>
								<a class="btn get-started-btn" href="{{ url('listartikelpendidikan') }}">Get Started</a>
                            </div>
                        </div>
                        <div class="single-slider slider-bg-5 text-center">
                            <div class="slider-inner">
                                <h1>Pariwisata</h1>
								<a class="btn get-started-btn" href="{{ url('listartikel') }}">Get Started</a>
                            </div>
                        </div>
                        <div class="single-slider slider-bg-4 text-center">
                            <div class="slider-inner">
                                <h1>Pertanian</h1>
								<a class="btn get-started-btn" href="{{ url('listartikelpertanian') }}">Get Started</a>
                            </div>
                        </div>
                        <div class="single-slider slider-bg-6 text-center">
                            <div class="slider-inner">
                                <h1>UMKM</h1>
								<a class="btn get-started-btn" href="{{ url('listartikelumkm') }}">Get Started</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12" id="galeri">
                    <div class="project-carousel owl-carousel text-center">
                        @foreach($galeri as $g)
                            <div class="single-project" style="background-image:url('{{ url('/Galeri/'.$g->gambar) }}')">
                                <div class="project-inner">
                                    {{--  <td><img src="{{url('/BPPUPS/'.$g->gambar) }}"></td>  --}}
                                    <h5><a href="#">{{ $g->deskripsi }}</a></h5>
                                    <p><a href="#">{{ $g->kategori }}</a></p>
                                </div>
                            </div>
                        @endforeach
                    </div>
                    <a href="{{ url('foto') }}" id="lihatsemua" class="btn btn-primary">Lihat Semua...</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Start Carousel Area -->
    <div class="carousel-area pt-80 pb-50" id="blog">
        <div class="container">
                <div class="col-lg-12 text-center mb-70">
                    <div class="section-title">
                        <h4>Berita</h4>
            ...
            @foreach($bppup as $b)
                <div class="col-lg-6">
                    <div class="card beritaberanda">
                        <div class="blog-carousel owl-carousel">
                            <div class="single-blog-item">
                                <div class="single-blog-img">
                                <img src="{{url('/BPPUPS/'.$b->gambar) }}">
                                    <span>{{ $b->created_at }}</span>
                                </div>
                                <div class="blog-content">
                                    <h5 class="post-heading"><a href="#">{{ $b->judul }}</a> </h5>
                                    <p class="post-content-text">
                                    <?php
                                        echo (str_word_count($b->isi) > 25  ? substr($b->isi,0,100)." ..." : $b->isi);
                                    ?>
                                    </p>
                                    <div class="blog-btn">
                                        <div class="blog-tags">
                                        ...
                                        <form method="get" action="{{ url('tani')}}">
                                            ...
                                            <input type="submit" class="btn btn-secondary" value="Baca selanjutnya..."/>
                                        </form>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-6 col-12 text-center d-flex align-items-center">
                    <div class="hire-us-content">
                        <div class="section-title">
                            <h4>Ikuti Pelatihan Pertanian</h4>
                        </div>
                        <a href="{{ url('tani') }}" class="btn hire-us-btn">GABUNG</a>
                    </div>
                </div>
