...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- End of Sidebar -->
                                                ...
                                                <div class="container">
                                                <form method="POST" action="{{ url('galeri/edit/proses/'.$galeri->id) }}" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="exampleFormControlGambar" name="deskripsi" rows="3">{{ $galeri->deskripsi }}</textarea>
                                                    </div>
