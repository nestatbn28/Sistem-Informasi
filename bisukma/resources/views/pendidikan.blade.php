...
<body>
    <!-- Color Nip -->
    <div class="Switcher">
    <button id="Switcher_control" class="Switcher_control">
            ...
            <div class="row">
                <div class="col-lg-12 text-center mb-30">
                    <div class="section-title">
                        <h4 style="padding-top:10px;">{{ $bppup->judul }}<br></h4>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-9">
                    <div class="text-center">
                        <td><img src="{{url('/BPPUPS/'.$bppup->gambar) }}"></td>
                    </div>
                    <div>
                        <p>{{$bppup->isi }}</p>
                    ...
                    <div class="text-center">
                        <iframe width="420" height="315" src="{{ $bppup->linkyt }}" frameborder="0" allowfullscreen></iframe>
                    </div>
                    <div class="text-center">
                        <a href="{{ $bppup->googleform }}">Pendaftaran</a>
                    </div>
                </div>
    ...
    <div class="choose-us-area black-bg pt-5 pb-5" id="page">
        ...
        <div class="container">
            <form action="{{ url('komentar/proses/'.$bppup->id) }}" method="POST">
                {{ csrf_field() }}
                        <input type="text" placeholder='Nama' name="nama" style="width:100%; margin-bottom:3px;">
                        <div class="form-group">
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="isi" placeholder="Masukkan Komentar anda"></textarea>
                        </div>
                        <input type="hidden" placeholder='Nama' name="bppup_id" style="width:100%; margin-bottom:3px;" value="$bppup->id">
