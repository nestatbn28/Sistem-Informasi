...
<body>
    ...
    <div class="latest-project-area pt-70 pb-70" id="portfolio" style="background-color:#32A195;">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12" id="galeri">
                    ...
                    @foreach($galeri as $g)
                        <div class="col-md-4 single-project" style="background-image:url('{{ url('/Galeri/'.$g->gambar) }}')">
