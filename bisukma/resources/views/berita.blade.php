...
<body>
    ...
    <div class="choose-us-area pt-40 pb-70" id="page" style="background-color:#32A195;">
        <div class="row">
        ...
        <div class="card container">
            <div class="row">
                <div class="col-lg-12 text-center mb-70">
                    <div class="section-title">
                        <h4 style="padding-top:15px;">Yonif 411/PDW berikan bimbel kepada pelajar Kampung Kirelly</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="text-center">
                        <img src="{{url('/img/pendidikan1.jpg')}}" alt="">
                    </div>
                    <div>
                        <p>Morbi vehicula a nibh in commodo. Aliquam quis dolor eget lectus pulvinar malesuada. Suspendisse eu rhoncus ligula.Morbi vehicula a nibh in commodo. Aliquam quis dolor eget lectus pulvinar malesuada. Suspendisse eu rhoncus ligula.Morbi vehicula a nibh in commodo. Aliquam quis dolor eget lectus pulvinar malesuada. Suspendisse eu rhoncus ligula.Morbi vehicula a nibh in commodo. Aliquam quis dolor eget lectus pulvinar malesuada. Suspendisse eu rhoncus ligula.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="choose-us-area black-bg pt-5 pb-5" id="page">
        ...
        <div class="container">
            <form action="">
                        <input type="text" placeholder='Nama' style="width:100%; margin-bottom:3px;">
                        <div class="form-group">
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Masukkan Komentar anda"></textarea>
                        </div>
    ...
    <div class="choose-us-area black-bg pt-5 pb-5" id="page">
        ...
        <div class="container">
            <div class="card">
                        <p><b style="margin-left:5px;">Josua Panggabean</b> : Berita nya sangat bagus dan bermanfat serta informatif</p>
            </div>
            <div class="card">
