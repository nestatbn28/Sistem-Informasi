            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="single-icon-box icon-box-img-1">
                        <div class="icon-box-content">
                            <h6 class="iconbox-content-heading"><i class="far fa-chart-bar"></i> Production Manager</h6>
                            <div class="iconbox-content-body">
                                <p>PT. Kemet Electronics Indonesia <br>Periode Waktu Desember 2017 – Saat ini</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="single-icon-box icon-box-img-2">
                        <div class="icon-box-content">
                            <h6 class="iconbox-content-heading"><i class="fas fa-cogs"></i> Technical Antenna Manager</h6>
                            <div class="iconbox-content-body">
                                <p>PT.Schneider Electric Manufacturing Batam, <br>Periode Waktu 2011 – 2012 <br> Manage New Product, Existing Product Evolution</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="single-icon-box icon-box-img-3">
                        <div class="icon-box-content">
                            <h6 class="iconbox-content-heading"><i class="fas fa-chart-line"></i> Quality Manager</h6>
                            <div class="iconbox-content-body">
                                <p>PT. Schneider Electric Manufacturing Batam <br>Periode Waktu September 2004 – Mei 2017</p>
                            </div>
                        </div>
                    </div>
                </div>
